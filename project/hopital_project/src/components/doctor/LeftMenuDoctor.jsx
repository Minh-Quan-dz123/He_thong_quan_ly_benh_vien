...
export default function LeftMenu() {
    ...
    const menuItems = [
        ...
        { label: "Hospital Doctor List", to: "/HomeAdmin/ManageDoctors" },
        { label: "Add Doctor", to: "/HomeAdmin/CreateDoctor"},
        { label: "Doctor Information Management", to: "/HomeAdmin/ManageDoctorInfor"}
    ];

...
const Navbar = ({ onSignInClick, isLoggedIn, username, role, onLogout }: NavbarProps) => {
  ...
  //const navigate = useNavigate(); ko dùng đến thì comment
          ...
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            {!isLoggedIn ? (
              ...
              <>
                ...
                {role === 'patient' && (
                  <Link to="/records" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Hồ sơ bệnh án</Link>
                )}
                <button
                  onClick={() => {
                    setIsDropdownOpen(false);

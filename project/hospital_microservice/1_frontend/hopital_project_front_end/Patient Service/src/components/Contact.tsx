      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-xl text-gray-500">
            We are here to help. Reach out to us for any inquiries or appointments.
          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-1 text-gray-500">123 Medical Center Dr, Health City, HC 12345</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-1 text-gray-500">contact@medihealth.com</p>
                </div>
              </div>
            </div>
          </div>
